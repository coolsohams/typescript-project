...
player1Grid.drawGrid(document, "player1Grid", "choice");
const player1GuessGrid = new Grid();
player1Grid.drawGrid(document, "player1GuessGrid", "player1Guess");

const player2Grid = new Grid();
player1Grid.drawGrid(document, "player2Grid", "choice2");
const player2GuessGrid = new Grid();
player1Grid.drawGrid(document, "player2GuessGrid", "player2Guess");
